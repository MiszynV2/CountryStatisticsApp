import classes from "./LiteracyAndNumeracyRates.module.css";
import CovidApi from "../../services/covid-api";
import { useCallback, useEffect, useState } from "react";
import { LOADING_STATE } from "../../constants";
import { Bar } from "react-chartjs-2";

const LiteracyAndNumeracyRates = (props) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    const response = await CovidApi.LiteracyAndNumeracyRates(props.iso);
...
export default LiteracyAndNumeracyRates;
